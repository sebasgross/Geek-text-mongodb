...
public class AdminServices {
    ...
    public AdminServices(BookRepo bookRepo, AuthorRepo authorRepo, WishlistRepo wishlistRepo, WishlistRepo wishlistRepo1) {
...
*/
    ...
    //get only the current user's wish list
